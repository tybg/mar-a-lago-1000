## [Mar-a-lago-100 Landing Page](http://www.maralago1000.com)
...
* ...but baked in is passport, monogo/mongoose, cors, api, routing, etc.
...
7. Or after building with Grunt, just run node app.js to run locally with node
8. Voila!  Type `ctrl+c` to exit.
...
4. Or rely on nodemon with running without Grunt and using nodemon
